...
sub get_navigation_lab {
  return "<div id=\"navigation_lab\">
      ...
      &bull;&nbsp; <a href=\"//modbase.compbio.ucsf.edu/foxsdock//help.cgi?type=FAQ\">FAQ</a>&nbsp;
...
sub get_footer {
  return "<hr size='2' width=\"80%\"><div id='address'> Schneidman-Duhovny D, Hammel M, Sali A. Macromolecular docking restrained by a small angle X-ray scattering profile.
